...
const allSkillVectorButtons = document.querySelectorAll(
    ".skill-vector__button"
  ),
...
allSkillVectorButtons.forEach((btn, index) => {
  btn.addEventListener("click", function () {
    ...
    skillVector.style.transform =
      "translate(-50%, -50%) rotate(" + (45 * index + 1) + "deg)";
  });
});

const allTechnologyButtons = document.querySelectorAll(".technology__btn"),
